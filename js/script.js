...
async function searchHeros(textSearched) {
     ...
     let PUBLIC_KEY = "96a21f58871940726d2a239373ab21ad";
     let PRIVATE_KEY = "6ad140e0757f57dd8ae9853609ff7b9317073284";
     ...
     await fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&apikey=96a21f58871940726d2a239373ab21ad&hash=${hash}&ts=${ts}`)
...
(function (){
     ...
     if(currentTheme == null){
          ...
          themeButton.style.backgroundColor="#9c5513";
     ...
     switch(currentTheme){
          ...
          case "dark":
               ...
               themeButton.style.backgroundColor="#d86c6c";
